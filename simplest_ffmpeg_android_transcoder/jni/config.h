...
#define FFMPEG_CONFIGURATION "--target-os=linux --prefix=/home/mxy/Documents/work/android-x264 --enable-cross-compile --enable-runtime-cpudetect --disable-asm --arch=arm --cc=/usr/local/lib/android-ndk-r8b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc --cross-prefix=/usr/local/lib/android-ndk-r8b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi- --disable-stripping --nm=/usr/local/lib/android-ndk-r8b/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-nm --sysroot=/usr/local/lib/android-ndk-r8b/platforms/android-8/arch-arm --enable-gpl --enable-shared --disable-static --enable-nonfree --enable-version3 --enable-small --disable-vda --disable-iconv --enable-libx264 --enable-libfaac --enable-encoder=flv --enable-encoder=libx264 --enable-encoder=libfaac --enable-librtmp --enable-zlib --disable-ffprobe --disable-ffplay --disable-ffmpeg --disable-ffserver --disable-debug --extra-cflags='-I/home/mxy/Documents/work/android-x264/include -fPIC -DANDROID -D__thumb__ -mthumb -Wfatal-errors -Wno-deprecated -mfloat-abi=softfp -marm -march=armv7-a' --extra-ldflags=-L/home/mxy/Documents/work/android-x264/lib --extra-libs=-lrtmp"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2015
#define FFMPEG_DATADIR "/home/mxy/Documents/work/android-x264/share/ffmpeg"
#define AVCONV_DATADIR "/home/mxy/Documents/work/android-x264/share/ffmpeg"
